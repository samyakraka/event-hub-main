...
import { Search, Calendar, MapPin, Clock, TicketIcon, Menu, X, Filter, User } from "lucide-react"
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center py-4">
            ...
            <div className="hidden md:flex items-center space-x-3">
              <Button variant="outline" onClick={() => setShowMyTickets(true)} className="flex items-center space-x-2">
                ...
                {events
                  ...
                  .map((event) => (
                    <div key={event.id} className="border rounded-lg p-4 bg-white shadow-sm">
                      <h4 className="font-semibold text-red-800 mb-2 line-clamp-1">{event.title}</h4>
                      <p className="text-sm text-gray-600 mb-3 line-clamp-2">{event.description.slice(0, 100)}...</p>
                      <Button
                  ...
                  return (
                    ...
                    >
                      <div className="flex items-center justify-between mb-2">
                        ...
                        {ticket.checkedIn && <Badge className="bg-green-100 text-green-800 text-xs">Checked In</Badge>}
                      </div>
                      <p className="font-medium text-sm mb-1">Ticket ID: {ticket.id.slice(0, 8)}...</p>
                      <p className="text-xs text-gray-600 mb-3">QR: {ticket.qrCode.slice(0, 12)}...</p>
        ...
        <Card className="mb-6 sm:mb-8">
          <CardContent className="p-4 sm:p-6">
            ...
            <div className="space-y-4 sm:space-y-0 sm:flex sm:gap-4">
              ...
              {/* Filters */}
              <div className={`${showFilters || window.innerWidth >= 640 ? "block" : "hidden"} sm:block`}>
              ...
              <CardContent className="p-0">
                ...
                <div className="p-4 sm:p-6">
                  <div className="flex items-center justify-between mb-2">
                    ...
                    <Badge
                      className={`text-xs ${event.ticketPrice === 0 ? "bg-green-100 text-green-800" : "bg-blue-100 text-blue-800"}`}
                    >
                  ...
                  <div className="space-y-2 text-sm text-gray-500 mb-4">
                    <div className="flex items-center">
                      ...
                      <span className="truncate">{format(event.date, "MMM dd, yyyy")}</span>
                    </div>
                    <div className="flex items-center">
